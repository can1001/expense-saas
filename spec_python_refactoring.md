...
pnpm install
API_ORIGIN=http://localhost:8000 pnpm run dev   # :3000, /api/py/* → :8000 프록시
```
...
| **frontend** (Node) | `pnpm install && pnpm run build` | `pnpm start` | `NEXT_PUBLIC_API_BASE_URL=https://<backend>.onrender.com/api` |
