...
- [x] B7. 보안 점검 — 요청 바디/쿼리의 tenantId 수신 경로 전수 제거
...
- [x] C3. 초대 플로우 — `Invitation` 모델/API + 초대 토큰·카카오 로그인 결합
- [x] C4. "카카오 계정 연결" 메뉴 + 테넌트 미소속 안내 화면
- [x] C5. 보안 점검 — 이메일 자동 병합 경로 부재 확인 + 매칭 정책 문서화
