        ...
        <table className="w-full text-sm">
          ...
          <tbody>
            {categoryTotals.map(({ category, total, subItems }) => {
              ...
              const incomeRatio = totalIncome > 0 ? (total.cumulativeAmount / totalIncome * 100) : 0;
                  ...
                  >
                    <td className="px-3 py-2.5 text-gray-900">
                      <span className="inline-flex items-center gap-1">
                        ...
                        {total.itemName}
                        <span className="text-gray-500 text-xs ml-1">({incomeRatio.toFixed(0)}%)</span>
                      </span>
                    </td>
                    ...
                    <td className="px-3 py-2.5 text-right text-gray-900">{formatRate(total.executionRate)}</td>
                    ...
                    subItems.map((item) => {
                      ...
                      return (
                        <tr key={item.id} className="border-b hover:bg-gray-50">
                          ...
                          <td className="px-3 py-2 text-right text-gray-700">{formatRate(item.executionRate)}</td>
            ...
            <tr className="bg-green-100 font-bold">
              ...
              <td className="px-3 py-3 text-right text-green-700">{formatAmount(totals.cumulativeAmount)}</td>
