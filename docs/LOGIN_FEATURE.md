...
사용자 편의를 위해 아이디를 브라우저에 저장하는 기능

**구현 방식:**
- localStorage에 아이디 저장 (`rememberedUserId` 키 사용)
- 체크박스 선택 시 로그인 성공 후 아이디 저장
- 다음 방문 시 저장된 아이디 자동 입력 및 체크박스 자동 체크
...
**비밀번호 저장:**
- 브라우저의 자동완성 기능에 의존 (`autoComplete="current-password"`)
...
| 1.1 | 2026-03-28 | 아이디 기억하기 기능 추가 (섹션 4.6) |
