...
const tenantInfo = {
  ...
  plan: PlanType.PRO,
  description: '유앤아이환경기술 지출결의서 시스템 (제13기: 2026년)',
  maxUsers: 200,
  maxStorageMB: 51200,
};
...
const committees = [
  ...
  },
  {
    ...
    sortOrder: 2,
    departments: [
      { name: '대기측정팀', sortOrder: 1 },
      { name: '수질측정팀', sortOrder: 2 },
      { name: '소음진동팀', sortOrder: 3 },
      { name: '실내환경팀', sortOrder: 4 },
    ],
  },
  {
    name: '분석본부',
    sortOrder: 3,
    departments: [
      { name: '이화학분석팀', sortOrder: 1 },
      { name: '미생물분석팀', sortOrder: 2 },
      { name: '중금속분석팀', sortOrder: 3 },
    ],
  },
  {
    name: '환경관리대행본부',
    sortOrder: 4,
    departments: [
      { name: '수질관리대행팀', sortOrder: 1 },
      { name: '대기관리대행팀', sortOrder: 2 },
      { name: '폐기물관리팀', sortOrder: 3 },
    ],
  },
  {
    name: '영업본부',
